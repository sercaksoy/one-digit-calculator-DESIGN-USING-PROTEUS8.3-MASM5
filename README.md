...
## CALISTIRILMASI ICIN:
"one-digit-calculator.pdsprj" adlı dosyanın Proteus 8.3 sürümü ile çalıştırılması, ayrıca assembly kodunun derlenebilmesi için program çalıştırılmaya başlanmadan önce <u>MASM compilerın indirilmiş</u> olması gerekmektedir. Compiler'i etkin projede aktif hale getirdiğiniz takdirde projeyi simüle edebilirsiniz.
